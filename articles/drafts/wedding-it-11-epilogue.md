...
slug: "wedding-it-11-epilogue"
description: "NFCタグを「ゲーム道具」から「思い出の鍵」に変える。称号システム、サンキューページ、フォトギャラリー。イベント終了後の余韻を設計するエピローグ篇。"
tags: [NextJS, Supabase, NFC, UXDesign, SystemDesign]
category: "dev-tips"
author: "tinou"
...
## 〜ゲーム道具を「思い出の鍵」に変える発想の転換〜

---

## 🎯 この記事で得られること

> - NFCタグを「ゲーム道具」から「思い出の鍵」に変える設計思想
> - `percent_rank()` を使った称号システムの実装
> - Server Actions によるサンキューページの構築
> - 一括ダウンロード付きフォトギャラリーの設計
