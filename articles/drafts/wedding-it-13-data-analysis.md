...
slug: "wedding-it-13-data-analysis"
description: "52人のゲスト、379枚の写真、156通のメッセージ、2,628件のトランザクション。結婚式カジノの全データをSQLで分析し、設計の正解と反省をデータで証明する。"
tags: [Supabase, PostgreSQL, DataAnalysis, SQL, Wedding]
category: "dev-tips"
author: "tinou"
...
でもその1件1件が、**誰かが写真を撮った瞬間**であり、**誰かがメッセージを書いた瞬間**であり、**誰かが大予想の結果に歓声を上げた瞬間**です。

データ分析で見えるのは「何が起きたか」。でも本当に大切なのは「なぜ起きたか」──52人のゲストがスマホを手に取り、写真を撮り、メッセージを書き、チップを乗せた**動機**です。
