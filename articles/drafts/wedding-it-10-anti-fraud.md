...
slug: "wedding-it-10-anti-fraud"
description: "結婚式カジノのゲームバランスを守る多層防御。クライマックスルール、冪等性保証（source_ref）、PIN認証レート制限、不正画像検出（AWS Rekognition DetectModerationLabels）の実装を解説。"
tags: [Supabase, PostgreSQL, Security, GameDesign, RLS]
category: "dev-tips"
author: "tinou"
