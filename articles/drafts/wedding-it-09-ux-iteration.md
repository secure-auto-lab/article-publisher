...
slug: "wedding-it-09-ux-iteration"
description: "「チップを払ってメッセージを送る」が機能しなかった理由と、「送ると500チップもらえる」に反転させたUX改善の全記録。3カテゴリ制、いいね報酬、新郎新婦からの返信機能まで、メッセージを中心にした体験設計を解説。"
tags: [NextJS, Supabase, UXDesign, GameDesign, SystemDesign]
category: "dev-tips"
author: "tinou"
...
ゲーミフィケーションの設計では、**ユーザーに「やらない理由」を与えないこと**が重要です。報酬があり、ガイドがあり、フィードバックがある。この3つが揃えば、ゲストは自然にメッセージを送ってくれます。
